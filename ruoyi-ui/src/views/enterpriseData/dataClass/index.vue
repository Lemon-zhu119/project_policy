    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleCategoryAdd"
          v-hasPermi="['system:companyClass:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
      ...
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['system:companyClass:export']">导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="companyCategoryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="text" @click="getCategoryData(scope.row.id)"
            v-hasPermi="['system:companyClass:query']">查看</el-button>
          <el-button size="mini" type="text" @click="handleUpdateCompanyCategory(scope.row)"
            v-hasPermi="['system:companyClass:edit']">修改</el-button>
          <el-button size="mini" type="text" @click="handleDeleteCompanyCategory(scope.row)"
            v-hasPermi="['system:companyClass:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog title="分类明细" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleCategoryDataAdd"
          style="position: absolute; top: 1.8vh; left: 6vw" v-hasPermi="['system:companyClass:add']">新增</el-button>
      </el-col>
      <div class="table">
        <el-table :data="categroyData" height="250" border style="width: 100%">
          ...
          <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
            <template slot-scope="scope">
              <el-button size="mini" type="text" @click="handleUpdateCompanyCategoryData(scope.row)"
                v-hasPermi="['system:companyClass:edit']">修改</el-button>
              <el-button size="mini" type="text" @click="handleDeleteCompanyCategoryData(scope.row)"
                v-hasPermi="['system:companyClass:remove']">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
